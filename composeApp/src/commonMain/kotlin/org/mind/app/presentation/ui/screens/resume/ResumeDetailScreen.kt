        ...
        Column(
            ...
            workExperienceList.forEachIndexed { index, experience ->
                WorkExperienceEntry(
                    ...
                    onRemove = { workExperienceList = workExperienceList.toMutableList().apply { removeAt(index) } }
                )
            }
            Button(onClick = { workExperienceList = workExperienceList.toMutableList().apply { add(WorkExperience()) } }) {
            ...
            educationList.forEachIndexed { index, education ->
                EducationEntry(
                    education = education,
                    onRemove = { educationList = educationList.toMutableList().apply { removeAt(index) } }
                )
            }
            Button(onClick = { educationList = educationList.toMutableList().apply { add(Education()) } }) {
                Text("Add Education")
            }
            ...
            skillsList.forEachIndexed { index, skill ->
                SkillEntry(skill = skill, onRemove = { skillsList = skillsList.toMutableList().apply { removeAt(index) } })
            }
            Row(
                modifier = Modifier.fillMaxWidth(),
